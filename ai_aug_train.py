...
path_aug_x = "/home/id202188552/water_seg/xtrain"

path_aug_y = "/home/id202188552/water_seg/ytrain"

path_val_aug_x = '/home/id202188552/water_seg/xval'

path_val_aug_y = '/home/id202188552/water_seg/yval'
...
history = model.fit(x_train, ohy_train, batch_size=32, epochs=20, verbose=1, validation_data=(x_val, ohy_val), callbacks=[checkpointer]) # , tensorboard_callback
